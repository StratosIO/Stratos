...
def transcribe():
    if "audio" not in request.files:
        return jsonfy({"error" : "No audio file provided"}), 400
    ...
    try:
        ...
        return jsonfy({"transcription": result.stdout.strip()})
    except subprocess.CalledProcessError as e:
        return jsonfy({"error": "Error processing transcription", "details": str(e)}), 500
